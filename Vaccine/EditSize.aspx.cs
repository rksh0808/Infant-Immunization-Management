...
public partial class EditSize : System.Web.UI.Page
{
    ...
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["VaccineDB"].ConnectionString);
    ...
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["VaccineDB"].ConnectionString))
        {
            con.Open();
